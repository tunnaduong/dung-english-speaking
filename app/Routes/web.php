...
$route->post('/exercises/homeworks/{id}/submit-writing', [HomeController::class, 'submitWritingHomework']);
$route->post('/exercises/homeworks/{id}/submit-reading', [HomeController::class, 'submitReadingHomework']);
$route->post('/exercises/homeworks/{id}/submit-listening', [HomeController::class, 'submitListeningHomework']);
$route->get('/exercises/tests', [HomeController::class, 'test']);
$route->post('/exercises/tests/{id}/submit-writing', [HomeController::class, 'submitWritingTest']);
$route->post('/exercises/tests/{id}/submit-reading', [HomeController::class, 'submitReadingTest']);
$route->post('/exercises/tests/{id}/submit-listening', [HomeController::class, 'submitListeningTest']);
$route->get('/exercises/tests/{id}', [HomeController::class, 'doTest']);
...
$route->post('/classrooms/{id}/attendance/submit', [TeacherController::class, 'submitAttendance']);
