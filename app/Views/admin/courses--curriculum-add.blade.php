...
@section('content')
    <div class="w-100 my-4 bg-white rounded-4 p-4 border-line">
        ...
        <div>
            <h4 class="fw-bold"><a href="{{ route('courses') }}" class="back-link">Courses</a>/<a
                    href="{{ route('courses/' . $id . '/curriculum') }}" class="back-link">Curriculum</a>/Create
            </h4>
        ...
        <form method="POST" action="" id="createCurriculumForm" class="my-4">
            ...
            <table class="w-100">
                ...
                <tr>
                    <td>Exercise</td>
                    <td>
                        <select name="exercise_id" class="form-select w-200 rounded-35 bg-light">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="d-flex justify-content-around">
                        <a class="btn btn-confirm" href="{{ route("courses/$id/curriculum") }}">Yes</a>
