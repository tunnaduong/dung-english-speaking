                    ...
                    <div class="col-md-6">
                        <div>
                            ...
                            <input type="number" min="1" max="10" name="shift1" id="shift1"
                                class="form-control" value="{{ old('shift1') }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div>
                            ...
                            <input type="number" min="1" max="10" name="shift2" id="shift2"
                                class="form-control" value="{{ old('shift2') }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div>
                            ...
                            <select name="day_of_week1" id="day_of_week" class="form-select">
                                ...
                                <option value="Monday" {{ old('day_of_week1') == 'Monday' ? 'selected' : '' }}>Monday
                                </option>
                                <option value="Tuesday" {{ old('day_of_week1') == 'Tuesday' ? 'selected' : '' }}>Tuesday
                                </option>
                                <option value="Wednesday" {{ old('day_of_week1') == 'Wednesday' ? 'selected' : '' }}>
                                    Wednesday</option>
                                <option value="Thursday" {{ old('day_of_week1') == 'Thursday' ? 'selected' : '' }}>Thursday
                                </option>
                                <option value="Friday" {{ old('day_of_week1') == 'Friday' ? 'selected' : '' }}>Friday
                                </option>
                                <option value="Saturday" {{ old('day_of_week1') == 'Saturday' ? 'selected' : '' }}>Saturday
                                </option>
                                <option value="Sunday" {{ old('day_of_week1') == 'Sunday' ? 'selected' : '' }}>Sunday
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div>
                            ...
                            <select name="day_of_week2" id="day_of_week" class="form-select">
                                <option value="" disabled selected>Select Day of Week</option>
                                <option value="Monday" {{ old('day_of_week2') == 'Monday' ? 'selected' : '' }}>Monday
                                </option>
                                <option value="Tuesday" {{ old('day_of_week2') == 'Tuesday' ? 'selected' : '' }}>Tuesday
                                </option>
                                <option value="Wednesday" {{ old('day_of_week2') == 'Wednesday' ? 'selected' : '' }}>
                                    Wednesday</option>
                                <option value="Thursday" {{ old('day_of_week2') == 'Thursday' ? 'selected' : '' }}>Thursday
                                </option>
                                <option value="Friday" {{ old('day_of_week2') == 'Friday' ? 'selected' : '' }}>Friday
                                </option>
                                <option value="Saturday" {{ old('day_of_week2') == 'Saturday' ? 'selected' : '' }}>Saturday
                                </option>
                                <option value="Sunday" {{ old('day_of_week2') == 'Sunday' ? 'selected' : '' }}>Sunday
                                </option>
                            </select>
                        </div>
                    </div>
