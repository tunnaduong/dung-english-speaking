...
@section('title', 'Course Curriculum | DungES')
    ...
    <div class="w-100 my-4 bg-white rounded-4 p-4 border-line">
        ...
        <div>
            <div class="d-flex justify-content-between">
                <div>
                    <h4 class="fw-bold"><a href="{{ route('courses') }}" class="back-link">Classrooms</a>/Curriculum
                    </h4>
                    <div class="line-bottom"></div>
                </div>
                <a href="{{ route("courses/$id/curriculum/add") }}" class="btn-classroom px-3 w-auto"><img
                                            ...
                                            <div class="modal-body text-center">
                                                ...
                                                <div class="d-flex justify-content-around">
                                                    <a class="btn btn-confirm"
                                                        href="{{ route('courses/' . $id . '/curriculum/' . $curriculum['c_id'] . '/delete') }}">Yes</a>
