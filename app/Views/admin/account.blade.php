                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-center">
                                                <h5 class="fw-semi mb-4">Do you want to delete this account?</h5>
                                                <div class="d-flex justify-content-around">
                                                    <a class="btn btn-confirm"
                                                        href="{{ $account['role'] == 'Student' ? route('account/' . $account['id'] . '/delete-student') : route('account/' . $account['id'] . '/delete-employee') }}">Yes</a>
