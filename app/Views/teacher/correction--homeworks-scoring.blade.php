        ...
        <form action="" method="POST" class="m-0">
            <div>
                <h4 class="fw-bold"><a href="{{ route("correction/$id/homeworks") }}" class="back-link">
                        < Homeworks</a>/<a href="{{ route("correction/$id/homeworks/$homeworkId") }}"
                                class="back-link">Writing
                                1</a>/Trịnh Duy Hoàng
                </h4>
            ...
            <div class="d-flex justify-content-end mt-3 gap-4">
                ...
                <a href="{{ route("correction/$id/homeworks/$homeworkId") }}" class="btn-classroom">Cancel</a>
