                        ...
                        @foreach ($students as $student)
                            <tr>
                                ...
                                <td>{!! $student['score'] == null
                                    ? "<a href='" .
                                        route("correction/$id/tests/$homeworkId/" . $student['id']) .
                                        '?answer_id=' .
                                        $student['answer_id'] .
                                        "'>N/A</a>"
                                    : $student['score'] !!}</td>
                                <td><a href="{{ route("correction/$id/tests/$homeworkId/" . $student['student_id'] . '?answer_id=' . $student['answer_id']) }}"
                                        class="me-2">
